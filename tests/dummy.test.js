...
describe('favorite blog', () => {
  test('has the most likes', () => {
    expect(favoriteBlog(biggerList)).toEqual({
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      likes: 12,
    })
  ...
  test('return one blog if only one given', () => {
...
describe('most blogs', () => {
  test('returns most blogs author blogs\' number associated', () => {
...
describe('most likes', () => {
  test('returns most liked author and total likes of author', () => {
